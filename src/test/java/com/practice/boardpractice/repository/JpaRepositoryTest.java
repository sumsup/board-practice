...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("kim2", "pw", null, null, null));
    ...
    void givenParentCommentId_whenSelecting_thenReturnsChildComments() {
        ...
        assertThat(parentComment).get()
                .hasFieldOrPropertyWithValue("parentCommentId", null) // 대상 class에 해당 이름의 field와 값이 있는지.
    ...
    void givenParentComment_whenSaving_thenInsertsChildComment() {
        ...
        articleCommentRepository.flush(); // flush 하면 자동으로 변경된 엔티티 객체 업데이트.
